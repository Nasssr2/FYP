...
if ($num == 1){
    ...
    $sql = "UPDATE lost_post SET date ='$date',time='$time',area='$area',Place='$Place',Details='$Details'
...
mysqli_close($conn);
header("location:my_record_lost_post.php?Pet_ID=$Pet_ID");//?msg=Record+is+successfully+updated
?>
</body>
</html>