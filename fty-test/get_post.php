  ...
  <div id="searchResult">
    ...
    <?php
      ...
      if (isset($_GET['variety'])){
        if ($_GET['variety'] == 'all'){
          $sql = "SELECT Pet_image, Pet_Types, pet.Pet_Name, area, Place, time, date, get_post.Pet_ID FROM get_post, pet WHERE get_post.Pet_ID=pet.Pet_ID";
        }else
        $sql = "SELECT Pet_image, Pet_Types, pet.Pet_Name, area, Place, time, date, get_post.Pet_ID FROM get_post, pet WHERE get_post.Pet_ID=pet.Pet_ID AND Pet_Types LIKE'{$_GET['variety']}'";
      }else{
        $sql = "SELECT Pet_image, Pet_Types, pet.Pet_Name, area, Place, time, date, get_post.Pet_ID FROM get_post, pet WHERE get_post.Pet_ID=pet.Pet_ID"; //! need change
      }
