...
<?php include('header.php'); ?>
  ...
  <div id="searchResult">
    ...
    <?php 
    echo <<<EOD
      <button onclick="location.href='my_record_lost_post_change.php?Pet_ID=$Pet_ID'" type="button">修改</button>
      <button onclick="location.href='lost_post_del.php?Pet_ID=$Pet_ID'" type="button">剷除</button>
      EOD;
    ?>
  </div>
